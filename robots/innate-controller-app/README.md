...
{% hint style="info" %}
Note that we are still in beta for both versions, please reach out on Discord to get access.
{% endhint %}
...
{% hint style="warning" %}
**iOS Users:** The leader arm connects via USB-C and is not compatible with iOS devices. Reach out to Innate on [Discord](https://discord.com/invite/KtkyT97kc7) to get access to a free Android phone for leader arm teleoperation.
{% endhint %}
