...
**BASIC** is our embodied agent, named in tribute to the BASIC languages that hobbyists used in the early age of PCs. Think of it as the LLM OS running your agents and skills. When running, BASIC controls the robot autonomously following your instructions.
